...
public class TaskDetailActivityTest {
    ...
    public void taskDetailActivityTest() {
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.button_main_activity_add_task), withText("Add Task"),
                        childAtPosition(
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.my_task_input),
                        childAtPosition(
                                allOf(withId(R.id.ad),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                                0)),
                                3),
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.button_add_task_activity_add_task), withText("Add Task"),
                        childAtPosition(
                                allOf(withId(R.id.ad),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.text_view_task_detail_activity_task_title), withText("Test"),
